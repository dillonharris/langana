...
describe "Viewing the list of users" do
  ...
  it "shows only the workers with confirmed mobile numbers" do
    legit_worker1 = FactoryGirl.create(:worker, first_name: "LegitOne", mobile_number: "0791237894", service: "Building")
    legit_worker2 = FactoryGirl.create(:worker, first_name: "LegitTwo", mobile_number: "0791237895", service: "Electrical")
    legit_worker3 = FactoryGirl.create(:worker, first_name: "LegitThree", mobile_number: "0791237896", service: "Nannying")
    employer = FactoryGirl.create(:user, role: :employer, first_name: "Emplo",   mobile_number: "0799999999")
    unconfirmed_worker = FactoryGirl.create(:worker, first_name: "Unconfirmedworker", mobile_number: "0791239632", confirmed_at: nil)
